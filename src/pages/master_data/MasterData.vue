...
<template>
    ...
    <div class="p-2">
        <div class="even:bg-white odd:bg-gray-200 bg-gray-100 py-3 px-3 text-xs grid grid-cols-5 grid-rows-auto">
            ...
            <div class="flex gap-3 items-center">
                <FontAwesomeIcon :icon="faGear" @click="Page('master-data-detail/ship',routing)" class="text-blue-500 cursor-pointer"/>
        ...
        <div class="even:bg-white odd:bg-gray-200 bg-gray-100 py-3 px-3 text-xs grid grid-cols-5 grid-rows-auto">
            ...
            <div class="flex gap-3 items-center">
                <FontAwesomeIcon :icon="faGear" @click="Page('master-data-detail/port',routing)" class="text-blue-500 cursor-pointer"/>
                <!-- <FontAwesomeIcon :icon="faTrashAlt" class="text-red-500 cursor-pointer"/> -->
            </div>
        </div>
        <div class="even:bg-white odd:bg-gray-200 bg-gray-100 py-3 px-3 text-xs grid grid-cols-5 grid-rows-auto">
            ...
            <div class="flex gap-3 items-center">
                <FontAwesomeIcon :icon="faGear" @click="Page('master-data-detail/berth',routing)" class="text-blue-500 cursor-pointer"/>
                <!-- <FontAwesomeIcon :icon="faTrashAlt" class="text-red-500 cursor-pointer"/> -->
            </div>
        </div>
        <div class="even:bg-white odd:bg-gray-200 bg-gray-100 py-3 px-3 text-xs grid grid-cols-5 grid-rows-auto">
            ...
            <div class="flex gap-3 items-center">
                <FontAwesomeIcon :icon="faGear" @click="Page('master-data-detail/cargo',routing)" class="text-blue-500 cursor-pointer"/>
                <!-- <FontAwesomeIcon :icon="faTrashAlt" class="text-red-500 cursor-pointer"/> -->
            </div>
        </div>
    </div>
